...
normalbases = set('ACGT')
inputbases = set(DNASeq)

if inputbases <= normalbases:
	...
	bad_bases = [c for c in inputbases if c not in normalbases]
	bad_list = ''.join(bad_bases)
	print "You have entered invalid bases %s." % bad_list
